...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const message = error.response?.data?.message || error.response?.data?.detail || 'Invalid credentials. Please try again.';
      setApiError(message);
    }
  };
      ...
      <div className="lx-root">
        ...
        <div className="lx-right">
          <div className={`lx-form-wrap ${mounted ? 'in' : ''}`}>
            ...
            <div className="lx-form-title">Welcome back.</div>
            <div className="lx-form-sub">Sign in to your workspace</div>

            {apiError && (
              <div className="lx-error">
                <IconAlert />
                <div>
                  <div className="lx-error-title">Authentication failed</div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="lx-meta">
                <button type="button" className="lx-meta-link">Forgot password?</button>
              </div>
            ...
            <div className="lx-footer">
              ...
              <div className="lx-register">
                No account yet?
                <button className="lx-register-btn" onClick={() => navigate('/register')}>Create one</button>
              </div>
            </div>
          </div>
        </div>
